...
ROWS = [
    ...
    dict(id="R01", item="R", name="FINDING 5: the inline `;` recipe refusal removed",
    ...
    dict(id="R04", item="R", name="FINDING 5: the indented-rule-line refusal removed",
    ...
    dict(id="R08", item="R", name="FINDING 5 class: the recipe reading stops at a conditional again",
         file="scripts/make-integrity-guard.py", old='        if line.split()[0] in MAKE_CONDITIONALS + ("else", "endif"):\n',
         new="        if False:\n",
         cmd=gotest("./scripts/", "TestMakeIntegrityGuardStillRefusesKnownShapesInReviewedBytes"),
         want="inside_a_conditional_within"),
